...
| 10 | Advanced glow & blur (NeonBlur, NeonBorderView, frosted-glass dialog, animated border) | ✅ Done | `done/10-advanced-glow-blur.md` |
| 11 | Win celebration & motion (NeonParticleView confetti, animated counter, dialog_win.xml) | ✅ Done | `done/11-win-celebration.md` |
| 12 | Theming đa sắc (4 accent themes, swatch picker, drawables ?attr/colorPrimary, recreate) | ✅ Done | `done/12-multi-theme.md` |
| 13 | Settings screen riêng (gom toggle + FX/theme/haptic/reduce-motion) | ✅ Done | `done/13-settings-screen.md` |
